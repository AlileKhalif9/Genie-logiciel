...
class Db_Facture(Data_Base):
    ...
    def add_receipt(self, order, order_quantities, date_creation, date_limite, price, status):
        ...
        if client_id is None:
            print(tr("Client_introuvable_pour_devis"))
    ...
    def remove_receipt(self, id_facture):
        ...
        self.conn.commit()
        self.disconnect()
        print(tr("Facture_supprimee_bdd").format(id=id_facture))
    ...
    def clear(self):
        ...
        self.conn.commit()
        self.disconnect()
        print(tr("Factures_supprimees_bdd"))
