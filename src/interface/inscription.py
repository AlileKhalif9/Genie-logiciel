...
class Affiche_Inscription(Tk):
    def __init__(self):
        ...
        print(f"👉 Création fenêtre inscription en langue : {get_langue()}")
        self.image_folder = os.path.join("res", "png", "image") 

        lang = "fr" if get_langue() == "FR" else "en"

        self.images = {
            "i_admail": PhotoImage(file=os.path.join(self.image_folder, f"adresse_mail_{lang}.png")),#
            "i_adpost": PhotoImage(file=os.path.join(self.image_folder, f"adresse_postale_{lang}.png")),#
            "i_cmdp": PhotoImage(file=os.path.join(self.image_folder, f"confirme_mdp_{lang}.png")),#
            "i_mdp": PhotoImage(file=os.path.join(self.image_folder, f"mdp_{lang}.png")),#
            "i_nom": PhotoImage(file=os.path.join(self.image_folder, f"nom_{lang}.png")),#
            "i_uti": PhotoImage(file=os.path.join(self.image_folder, f"nom_uti_{lang}.png")),#
            "i_prenom": PhotoImage(file=os.path.join(self.image_folder, f"prenom_{lang}.png")),#
            "i_telephone": PhotoImage(file=os.path.join(self.image_folder, f"telephone_{lang}.png")),#
            "i_societe": PhotoImage(file=os.path.join(self.image_folder, f"societe_{lang}.png")),
            "i_ok": PhotoImage(file=os.path.join(self.image_folder, "ok.png")),#
            "i_confirm": PhotoImage(file=os.path.join(self.image_folder, f"confirmer_{lang}.png")),#
            "fermer": PhotoImage(file=os.path.join(self.image_folder, "close.png"))#
