...
class Db_Devis(Data_Base):
    ...
    def add_quote(self, name, surname, phone, email, address,
        ...
        if client_id is None:
            print(tr("Client_introuvable_ajout_devis"))
    ...
    def remove_quote(self, id_devis):
        ...
        self.conn.commit()
        self.disconnect()
        print(tr("Devis_supprime_bdd").format(id=id_devis))
    ...
    def clear(self):
        ...
        self.conn.commit()
        self.disconnect()
        print(tr("Devis_supprimes_reset"))
        Factory_Quote.clear()
